 ...
 *
 * 契约来源: server/contract/calton-v1-corrected.json
 * sha256:   8f51607005721d55bce8d4f6de824a6cc1eaa20b28d2a520580c4e63af19ab57
 * 生成日期: 2026-08-03
 * path 数:  129
 * 修正版契约: 是
 * swagger2openapi patch: 警告 0 条、info 字段改动 0 处（详见 src/api/generated.provenance.json）
 */
export interface paths {
    ...
    "/info": {
        ...
        /**
         * Info
         * @description Returns the version, frontendurl, motd and various settings of Calton
         */
        get: {
            parameters: {
                query?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["shared.CaltonInfos"];
                    };
                };
            };
        };
    ...
    "/labels/{label}": {
         ...
         *
         *     [calton] Corrected from PUT /labels/{id}: pkg/routes/routes.go:784
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/migration/csv/migrate": {
        ...
        /**
         * Import CSV file
         * @description Imports tasks from a CSV file into Calton with the provided configuration.
         */
        put: {
            parameters: {
                query?: never;
    ...
    "/migration/microsoft-todo/auth": {
         ...
         * @description Returns the auth url where the user needs to get its auth code. This code can then be used to migrate everything from Microsoft Todo to Calton.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/migration/microsoft-todo/migrate": {
         ...
         * @description Migrates all tasklinsts, tasks, notes and reminders from Microsoft Todo to Calton.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/migration/ticktick/migrate": {
         ...
         * @description Imports all projects, tasks, notes, reminders, subtasks and files from a TickTick backup export into Calton.
         */
        put: {
            parameters: {
                query?: never;
    ...
    "/migration/todoist/auth": {
         ...
         * @description Returns the auth url where the user needs to get its auth code. This code can then be used to migrate everything from todoist to Calton.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/migration/todoist/migrate": {
         ...
         * @description Migrates all projects, tasks, notes, reminders, subtasks and files from todoist to calton.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/migration/trello/auth": {
         ...
         * @description Returns the auth url where the user needs to get its auth code. This code can then be used to migrate everything from trello to Calton.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/migration/trello/migrate": {
         ...
         * @description Migrates all projects, tasks, notes, reminders, subtasks and files from trello to calton.
         */
        post: {
            parameters: {
                query?: never;
    ...
    "/migration/calton-file/migrate": {
        ...
        put?: never;
        /**
         * Import all projects, tasks etc. from a Calton data export
         * @description Imports all projects, tasks, notes, reminders, subtasks and files from a Vikunjda data export into Calton.
         */
        post: {
            parameters: {
                query?: never;
            ...
            requestBody: {
                content: {
                    "application/x-www-form-urlencoded": {
                        /** @description The Calton export zip file. */
                        import: string;
                    };
                };
            };
    ...
    "/migration/wekan/migrate": {
         ...
         * @description Imports all projects, tasks, labels, checklists, comments, and attachments from a WeKan board JSON export into Calton.
         */
        put: {
            parameters: {
                query?: never;
    ...
    "/projects": {
        ...
        get: {
            parameters: {
                query?: {
                    /** @description If set to `permissions`, Calton will return the max permission the current user has on this project. You can currently only set this to `permissions`. */
                    expand?: string;
    ...
    "/projects/{project}/tasks": {
        ...
        /** @description [calton] Undocumented upstream but really routed: pkg/routes/routes.go:650 */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/projects/{project}/tasks/by-index/{index}": {
        ...
        get: {
            parameters: {
                query?: {
                    /** @description If set to `subtasks`, Calton will fetch only tasks which do not have subtasks and then in a second step, will fetch all of these subtasks. This may result in more tasks than the pagination limit being returned, but all subtasks will be present in the response. You can only set this to `subtasks`. */
                    expand?: string;
                };
                header?: never;
                path: {
    ...
    "/test/all": {
        ...
        /**
         * Truncate all tables
         * @description Removes all data from every Calton table. Used by e2e tests to ensure clean state before each test. Requires the testing token.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/token/test": {
        ...
        /** @description [calton] Undocumented upstream but really routed: pkg/routes/routes.go:545 */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/user/timezones": {
        ...
        /**
         * Get all available time zones on this calton instance
         * @description Because available time zones depend on the system Calton is running on, this endpoint returns a project of all valid time zones this particular Calton instance can handle. The project of time zones is not sorted, you should sort it on the client.
         */
        get: {
            parameters: {
                query?: never;
...
export interface components {
    schemas: {
        ...
        "code_calton_io_api_pkg_modules_auth_openid.Provider": {
            auth_url?: string;
            client_id?: string;
        ...
        "models.CreateUserBody": {
            ...
            is_admin?: boolean;
            /** @description The language of the new user. Must be a valid IETF BCP 47 language code and exist in Calton. */
            language?: string;
            /** @description The full name of the new user. Optional. */
            name?: string;
            /** @description The user's password in clear text. Only used when registering the user. The maximum limi is 72 bytes, which may be less than 72 characters. This is due to the limit in the bcrypt hashing algorithm used to store passwords in Calton. */
            password?: string;
        ...
        "models.ProjectView": {
            ...
            /** @description The filter query to match tasks by. Check out https://calton.io/docs/filters for a full explanation. */
        ...
        "models.Webhook": {
            ...
            project_id?: number;
            /** @description If provided, webhook requests will be signed using HMAC. Check out the docs about how to use this: https://calton.io/docs/webhooks/#signing */
            secret?: string;
        ...
        "shared.OpenIDAuthInfo": {
            enabled?: boolean;
            providers?: components["schemas"]["code_calton_io_api_pkg_modules_auth_openid.Provider"][];
        };
        "shared.CaltonInfos": {
